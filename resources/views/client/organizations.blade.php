...
<section id="hero">
    ...
    <div class="flex flex-row justify-center my-10">
        <form action="{{url('searchCompanyClient')}}" method="get">
            @csrf
            <input type="text" name="search" class="w-[200px] px-4 py-2 border border-black" placeholder="بحث عن مؤسسة" id="">
    ...
    <div class="container  mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-2 gap-y-10">
       ...
       <div class="flex flex-col space-x-2 items-start p-4 shadow-xl  w-[300px] bg-gray-200 mr-6 md:mr-0 ">
        ...
        <div class="flex flex-row justify-around ">
            <a href="{{url('followCompany',$item->id)}}"
