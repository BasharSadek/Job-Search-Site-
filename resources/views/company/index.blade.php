        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h6 font-weight-bold text-info text-uppercase mb-1">الدورات
                            </div>
                            <div class="font-weight-bold ml-3 text-muted" style="font-size: 28px;">{{$course}}</div>
        ...
        {{-- <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h6 font-weight-bold text-info text-uppercase mb-1">الأقسام
                            </div>
                            <div class="font-weight-bold ml-3 text-muted" style="font-size: 28px;">4</div>
                        </div>
                        <div class="col-auto ml-3">
...
<br>
    <table class="table">
        <tbody>
          ...
          <tr>
            <td style="font-size: 30px"> المتابعون </td>
            <td style="width: 80%">
              <div class="progress">
