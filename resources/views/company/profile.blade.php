...
<div class="container">
    ...
    @endif
    <div class="mx-3 text-center shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form action="{{url('storeProfileCompany')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td ><input type="text" class="selectoption" name="specialy"  value="{{$user->specialy}}"></td>
                <div class="red">@error('specialy'){{$message}}@enderror</div>
            </tr>
            <tr>
                <td class="table-active"> <b>وصف الموقع</b>  </td>
                <td ><textarea name="description" class="selectoption" cols="30" rows="5">{{$user->description}}</textarea></td>
