...
<div class="container">
    ...
    @endif
    <div class="mx-3 text-center shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form action="{{url('UpdateCourse',$course->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
        <table class="table">
            ...
            <tr>
                ...
                <td ><input type="number" class="selectoption" name="course_cost" required value="{{$course->course_cost}}"></td>
