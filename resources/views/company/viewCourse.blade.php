...
@section('title') دورات الشركة @endsection
@section('body')
<div class="container">
    <div class="mx-3  shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <h3 class="text-center"> الدورات </h3>
        <h4 class="text-left btn btn-primary"><a class="addElem" href="{{url('addCourse')}}"><b>اضافة</b></a></h4>
    </div>
    ...
    <div class="mx-3 text-center shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        ...
        @foreach ($course as $item)
            <tr>
                ...
                <td>
                    <a onclick="return confirm('هل أنت متأكد من الحذف ؟')" class="btn btn-danger" href="{{url('deleteCourseCompany',$item->id)}}">حذف</a>
                    <a class="btn btn-success" href="{{url('editCourse',$item->id)}}">تعديل</a>
                  </td>
            </tr>
        @endforeach
            </table>
