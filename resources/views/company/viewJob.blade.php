...
@section('title')  وظائف الشركة@endsection
@section('body')
<div class="container">
    <div class="mx-3  shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <h3 class="text-center"> الوظائف </h3>
        <h4 class="text-left btn btn-primary"><a class="addElem" href="{{url('addJob')}}"><b>اضافة</b></a></h4>
    </div>
    ...
    <div class="mx-3 text-center shadow-lg p-3 mb-5 bg-body-tertiary rounded">
            ...
            <div class="bg-body-tertiary">
                <form action="{{url('searchCourseCompany')}}" method="get" class="m-3">
                    @csrf
        ...
        @foreach ($job as $item)
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-success" href="{{url('editJob',$item->id)}}">تعديل</a>
                  </td>
            </tr>
        @endforeach
            </table>
