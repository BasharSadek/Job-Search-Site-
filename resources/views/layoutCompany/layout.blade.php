...
<head>
  ...
  @include('layoutCompany.css')
</head>
<body dir="rtl">
    <!-- Page Wrapper -->
    <div id="wrapper">
   @include('layoutCompany.sidebar')
        <!-- Content Wrapper -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow float-left">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{url('showProfileCompany')}}">
 ...
 @yield('body')
           ...
           @include('layoutCompany.footer')
        </div>
        <!-- End of Content Wrapper -->
    </div>
 @include('layoutCompany.js')
</body>
